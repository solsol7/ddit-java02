...
public class FileTest01 {
	...
	public static void main(String[] args) {
		...
		//File file1 = new File("d:\\D_Other\\test.txt");	//구분문자를 역슬래쉬('\')로 사용 - 역슬래쉬는 큰 따옴표 안에 쓸 때 두번 써줘야함
		File file1 = new File("d:/D_Other/test.txt");	//구분문자를 슬래쉬('/')로 사용
		...
		/*
		 ...
		 - mkdirs()	==> 전체 경로 중에서 중간 부분이 없으면 중간 부분의 경로도 같이 만들어 준다.
		 */
