...
public class FileTest03 {
	...
	// 디렉토리 정보를 갖는 File객체를 매개변수로 받아서 해당 디렉토리 안에 있는 모든 파일과 디렉토리 목록을 출력하는 메서드
	public void displayFileList(File dir) {
		...
		//String[] fileStrs = dir.list();			//얘를 쓰면 File객체 각각을 만들어줘야함
		
		SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd a HH:mm");		//a->오전인지 오후인지
